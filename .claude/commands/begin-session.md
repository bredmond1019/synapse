...
3. **`$BRAIN_ROOT/planning/open-work/pre-plan/<slug>/notes.md`** — a `/capture` holding area.
...
- **Reads:** `planning/state.json`, the roadmap, `$BRAIN_ROOT/planning/open-work/pre-plan/<slug>/notes.md`, `brain.toml`
